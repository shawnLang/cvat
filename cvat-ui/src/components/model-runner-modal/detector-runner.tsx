    ...
    useEffect(() => {
        ...
        if (model) {
            ...
            if (!model.labels.length && model.kind !== ModelKind.REID) {
                notification.warning({ message: '此模型没有指定的标签' });
            }
        } else {
            setModelLabels([]);
        }
    ...
    return (
        <div className='cvat-run-model-content'>
            <Row align='middle'>
                ...
                <Col span={20}>
                    <Select
                        placeholder={dimension === DimensionType.DIMENSION_2D ? '选择模型' : '没有模型'}
            ...
            {isDetector && (
                <div className='cvat-detector-runner-threshold-wrapper'>
                    <Row align='middle' justify='start'>
                        ...
                        <Col>
                            <Text>阈值</Text>
                            <CVATTooltip title='检测的最小置信阈值。留空以使用模型设置中指定的默认值'>
            ...
            {isReId ? (
                <div>
                    <Row align='middle' justify='start'>
                        ...
                        <Col offset={1}>
                            <CVATTooltip title='可以合并的形状的最小相似值'>
                                <InputNumber
                                    min={0.01}
                                    step={0.01}
                                    max={1}
                    ...
                    <Row align='middle' justify='start'>
                        ...
                        <Col offset={1}>
                            <CVATTooltip title='可以合并的形状之间的最大距离'>
                                <InputNumber
                                    placeholder='阈值'
                                    min={1}
                                    value={distance}
