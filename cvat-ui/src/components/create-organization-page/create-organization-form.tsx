    ...
    return (
        ...
        >
            <Form.Item
                ...
                label='简称'
                rules={[
                    { required: true, message: '简称是必填字段' },
                    { max: MAX_SLUG_LEN, message: `简称不能超过 ${MAX_SLUG_LEN} 字符` },
            ...
            <Form.Item
                ...
                name='name'
                label='全名'
                rules={[{ max: MAX_NAME_LEN, message: `全名不能超过 ${MAX_NAME_LEN} 字符` }]}
            >
                <Input />
            </Form.Item>
            ...
            <Form.Item hasFeedback name='email' label='邮箱' rules={[{ type: 'email', message: '输入的邮箱无效' }]}>
                <Input autoComplete='email' placeholder='support@organization.com' />
            </Form.Item>
            <Form.Item hasFeedback name='phoneNumber' label='电话' rules={[{ ...validationPatterns.validatePhoneNumber }]}>
