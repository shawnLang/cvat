...
function LockAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={`锁定所有属性开关 ${switchLockAllShortcut}`}>
...
function HideAllSwitcher(props: Props): JSX.Element {
    ...
    return (
        <Col span={3}>
            <CVATTooltip title={`隐藏所有属性开关 ${switchHiddenAllShortcut}`}>
                {statesHidden ? (
